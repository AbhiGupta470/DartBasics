...
class HealthyWorkOutsScreen extends StatefulWidget {
  const HealthyWorkOutsScreen({Key? key}) : super(key: key);

  @override
  State<HealthyWorkOutsScreen> createState() => _HealthyWorkOutsScreen();
}

class _HealthyWorkOutsScreen extends State<HealthyWorkOutsScreen> {
  @override
          ...
          Card(
            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                Row(
                  children: [
                    Text("  Prevent: Diabetes and High Cholestrol.",
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 15,
                            letterSpacing: 2.0)),
