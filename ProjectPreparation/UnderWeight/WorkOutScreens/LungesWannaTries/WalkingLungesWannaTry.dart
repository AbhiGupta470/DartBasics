...
class WalkingLungesWannaTry extends StatefulWidget {
  const WalkingLungesWannaTry({Key? key}) : super(key: key);

  @override
  State<WalkingLungesWannaTry> createState() => _WalkingLungesWannaTry();
}

class _WalkingLungesWannaTry extends State<WalkingLungesWannaTry>
...
Step-5: Repeat this movement, “walking” forward as you lunge, alternating legs.Do 10 to 12 reps on each leg. Perform 2 to 3 sets.""",
                                style: TextStyle(
